...
pub async fn get_tenant(
    ...
    let response = TenantDetailResponse {
        ...
        description: tenant.description.clone(),
        active: tenant.active,
        identity_provider: serde_json::to_value(&tenant.identity_providers).map_err(|e| {
            error_response(
        ...
        identity_storage: serde_json::to_value(&tenant.identity_storage).unwrap_or_else(|_| serde_json::json!({})),
...
pub struct CreateTenantRequest {
    ...
    #[allow(dead_code)]
    pub identity_storage: serde_json::Value,
}
...
mod tests {
    use super::*;
    use crate::models::{
        AppConfig, DatabaseStorageConfig, IdentityStorage, OAuth2ServerConfig, Tenant,
    };
